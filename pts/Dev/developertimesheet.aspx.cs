...
public partial class SPMT_SPMT_PROJECT_developertimesheet : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {                
                SqlCommand cmd = new SqlCommand("insert into timesheet values('" + DateTime.Now.ToString() + "','" + TextBox2.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "')", con);
                cmd.ExecuteNonQuery();
    ...
    {
        con.Open();
        SqlCommand cmd3 = new SqlCommand("update timesheet set developerid='" + TextBox2.Text +  "' ,projid='" + TextBox4.Text + "' ,projname='" + TextBox5.Text + "' ,modulename='" + TextBox6.Text + "', startdate='" + TextBox7.Text + "', enddate='" + TextBox8.Text + "', status='" + TextBox9.Text +"'  where  developerid='" + TextBox2.Text + "'", con);
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        if (dr1.Read())
        {
            ...
            TextBox8.Text = dr1[6].ToString();
            TextBox9.Text = dr1[7].ToString();
        }
        dr1.Close();
        con.Close();
    }

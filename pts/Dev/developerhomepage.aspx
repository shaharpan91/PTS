...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Menu ID="Menu1" runat="server" Height="72px" Style="z-index: 100; left: 269px;
        ...
        <Items>
            <asp:MenuItem NavigateUrl="~/DEV/modules.aspx" Text="Modules" Value="Modules"></asp:MenuItem>
            <asp:MenuItem NavigateUrl="~/Dev/developertimesheet.aspx" Text="TimeSheet" Value="TimeSheets"></asp:MenuItem>

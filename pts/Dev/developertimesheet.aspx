...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Dev/developerhomepage.aspx"
    ...
    <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="Medium" Text="Start Date" Width="128px"></asp:Label></td>
            <td style="width: 173px">
    <asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>(mm/dd/yy)</td>
        </tr>
        <tr>
            <td style="width: 100px">
    <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="Medium" Text="End Date" Width="128px"></asp:Label></td>
            <td style="width: 173px">
    <asp:TextBox ID="TextBox8" runat="server"></asp:TextBox>(mm/dd/yy)</td>
        </tr>
        <tr>
            <td style="width: 100px; height: 21px">
    ...
    <br />
    <br />
    <asp:Label ID="Label2" runat="server" Style="z-index: 101; left: 609px; position: absolute;
        top: 417px" Width="112px"></asp:Label>
    <br />

...
public partial class clientdetails : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //if (c != 1)
            //{
                SqlCommand cmd2 = new SqlCommand("insert into clientdetails values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox7.Text + "','" + TextBox3.Text + " ','" + TextBox4.Text + "','" +  TextBox6.Text + "')", con);
    ...
    public void ClearData()
    {
        ...
        ControlCollection C = P.Controls;

        foreach (WebControl W in C)
        {

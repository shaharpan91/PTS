    ...
    <asp:Menu ID="Menu1" runat="server" Height="184px" Style="z-index: 100; left: 189px;
        ...
        <Items>
            <asp:MenuItem Text="Client Details" Value="Client Details">
                <asp:MenuItem NavigateUrl="~/Client/clientdetails.aspx" Text="Add" Value="Add">
                </asp:MenuItem>
                <asp:MenuItem NavigateUrl="~/Client/viewclientdetails.aspx" Text="View"
                    Value="New Item"></asp:MenuItem>
            </asp:MenuItem>
            <asp:MenuItem Text="Project Details" Value="Project Details">
                <asp:MenuItem NavigateUrl="~/BDO/projectadddetails.aspx" Text="ADD" Value="New Item">
                </asp:MenuItem>
